...
cls 
echo Supported products:&echo - Windows 10 Home&echo - Windows 10 Professional&echo - Windows 10 Enterprise, Enterprise LTSB&echo - Windows 10 Education&echo.&echo Activation...
...
cscript //nologo slmgr.vbs /ato | find /i "successfully" && (exit) || (echo Connection to KMS server failed. Trying another one... & echo Please wait... & set /a i+=1 & goto server)
